...
public class aFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        getActivity().findViewById(R.id.editTextfragment);
        getActivity().findViewById(R.id.btnsend).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditText et=(EditText)getActivity().findViewById(R.id.editTextfragment);
                Log.d("demo","fragmenttext"+et.getText());
