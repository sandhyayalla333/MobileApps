...
public class DisplayProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView tv_name = view.findViewById(R.id.nameValue);
        TextView tv_idvalue=view.findViewById(R.id.tv_IdValue);
        TextView tv_dep=view.findViewById(R.id.deptVal);
        ImageView image=view.findViewById(R.id.pickedimage);

         bundle = this.getArguments();
        if (bundle != null) {
            tv_name.setText(bundle.get("fname")+" "+bundle.get("lname"));
            tv_idvalue.setText(bundle.get("id")+"");
            tv_dep.setText(bundle.get("dept")+"");
            int imageNum = bundle.getInt("imageNumber");
            if(imageNum==1)
            {
        ...
        btnedit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mListener.Oneditclicked(bundle);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        //Button btnedit=(Button)getActivity().findViewById(R.id.btnEdit);
